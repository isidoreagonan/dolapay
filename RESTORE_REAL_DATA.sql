-- ==========================================================================
-- SCRIPT DE RESTAURATION COMPLÈTE (AVEC COMPTES AUTH SUPABASE)
-- ==========================================================================
-- Exécute ce script dans le SQL Editor de ta nouvelle base Supabase.
-- Il recrée d'abord les identifiants d'authentification (auth.users) afin que 
-- la contrainte de clé étrangère "profiles_id_fkey" soit parfaitement respectée.

-- 0. CRÉATION DU COMPTE ADMIN DANS AUTH.USERS (mot de passe : isi57dore38)
...
-- Création des autres comptes utilisateurs dans auth.users
INSERT INTO auth.users (
  instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at
) VALUES (
  '00000000-0000-0000-0000-000000000000',
