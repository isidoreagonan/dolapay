-- ==========================================================================
-- SCRIPT DE RESTAURATION DÉFINITIF ET NETTOYÉ DE TOUT CONFLIT D'EMAIL
-- ==========================================================================
-- Exécute ce script dans le SQL Editor Supabase.
-- Étape 0 : Il supprime d'abord les comptes temporaires créés sur le nouveau Supabase
-- avec des IDs aléatoires pour libérer les emails et remettre les IDs exacts de Lovable Cloud.
