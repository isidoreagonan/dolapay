-- ==========================================================================
-- SCRIPT FINAL : RÉPARATION DE LA STRUCTURE DES COLONNES + RESTAURATION
-- ==========================================================================

-- 1. AJOUT DE TOUTES LES COLONNES MANQUANTES DANS PROFILES POUR ÉVITER L'ERREUR POSTGREST PGRST204
...
-- 3. CRÉATION DES COMPTES ORIGINAUX DANS AUTH.USERS
...
-- 7. RESTAURATION DES VRAIS LIENS DE PAIEMENT (AVEC MERCHANT_ID ET PROFILE_ID)
