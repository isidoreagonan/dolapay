-- ==========================================================================
-- MIGRATION DE SEED : DONNÉES DE DÉMO LOVABLE POUR DOLAPAY
-- Injection de comptes vérifiés (Enterprise & Standard), entreprises,
-- liens de paiement et transactions dans le projet Supabase.
-- ==========================================================================

DO $$
BEGIN
  -- 1) Insertion des utilisateurs dans auth.users (si autorisé par le rôle exécutant)
  BEGIN
  ...
  -- 2) Désactiver temporairement la contrainte FK sur profiles
  BEGIN
