...
//#region node_modules/.nitro/vite/services/ssr/assets/route-DVE8GcuK2.js
...
function DashboardLayout() {
	...
	(0, import_react.useEffect)(() => {
		if (typeof window !== "undefined") setTimeout(() => {
			if (window.location.hash === "#" || window.location.hash.includes("access_token") || window.location.hash.includes("error_description")) window.history.replaceState(null, "", window.location.pathname + window.location.search);
		}, 300);
