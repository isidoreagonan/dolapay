...
//#region node_modules/.nitro/vite/services/ssr/assets/developers.api-cTNn_Ogt.js
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("code", {
												...
												children: ["https://api.dolapay.co/v1", active.path]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CopyButton, { value: `https://api.dolapay.co/v1${active.path}` })
										]
									})
								]
							}),
