...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-eg5mLCmq.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D-rC0axS.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C0Gcb6hb.mjs"),
		import("./start-DUjKyHKv.mjs"),
